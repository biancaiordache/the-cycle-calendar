      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <select
            ...
            className="w-full max-w-full appearance-none rounded-lg border border-dark/20 bg-paper py-2.5 pl-4 pr-12 text-dark focus:border-dark focus:outline-none focus:ring-1 focus:ring-dark"
          >
            {iphoneModels.map((m) => (
